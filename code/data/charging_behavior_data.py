# -*- coding: utf-8 -*-
# @Author             : GZH
# @Created Time       : 2023/9/25 8:39
# @Email              : guozh29@mail2.sysu.edu.cn
# @Last Modified By   : GZH
# @Last Modified Time : 2023/9/25 8:39
...
if __name__ == '__main__':
    ...
    end_date=datetime.date(2023,8,26)
    ...
    for city in city_dict.keys():
        ...
        reader = pd.read_csv('./original_data/'+city+'.csv', iterator=True, chunksize=10000)
        ...
        charging_dataframe.to_csv('./city_statistics/' + city_dict[city][0] +'_to_'+str(end_date)+ '.csv', index=False)
